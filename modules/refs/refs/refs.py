...
import io
import modules.refs.refs.logger as logger
from modules.refs.refs.error import *
from modules.refs.refs.refs_type import *
from modules.refs.logfile.logfile import LogEntry
#from modules.refs.logfile.error import *
from modules.refs.chgjrnl.change_journal import USNRecordV3
...
class ReFSv3:
    ...
    def change_directory(self, obj):
        if self.object_table.table:
            ...
            return ReFSDirectory(self.vol, self.cluster, self, change_dir)
